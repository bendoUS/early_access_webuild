...
export function TimeLine_01({
  title = "Roadmap Webuild",
  description = "Découvrez notre plan de développement et les fonctionnalités que nous lançons dans les prochains mois pour révolutionner votre boutique Shopify.",
  entries = [],
}) {
